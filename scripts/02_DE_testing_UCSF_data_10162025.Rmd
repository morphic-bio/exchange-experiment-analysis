...
rownames(ttNW_parent)  <- map_symbols(rownames(ttNW_parent),  gene_anno)
...
write.table(ttNW[, 1:6], file = file.path(personal_path, paste0("/publication/", "UCSF_DE_NW.csv", sep='')),
            sep = "\t", quote = FALSE)
write.table(ttNW_parent[, 1:6], file = file.path(personal_path, paste0("/publication/", "UCSF_DE_NW_parent.csv", sep='')),
            sep = "\t", quote = FALSE)
